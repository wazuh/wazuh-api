 ...
 * @apiParam {String} [search] Looks for elements with the specified string.
 * @apiParam {String} [select] List of selected fields.
 * @apiParam {Number} [ram_free] Filters by ram_free.
 * @apiParam {Number} [ram_total] Filters by ram_total.
 * @apiParam {Number} [cpu_cores] Filters by cpu_cores.
...
/**
 * @api {get} /syscollector/processes Get processes info of all agents
 ...
 *
 * @apiExample {curl} Example usage*:
 *     curl -u foo:bar -k -X GET "https://127.0.0.1:55000/syscollector/processes?pretty"
 *
 */
router.get('/processes', function (req, res) {
    logger.debug(req.connection.remoteAddress + " GET /syscollector/processes");

    var data_request = { 'function': '/syscollector/processes', 'arguments': {} };
    var filters = {
        'offset': 'numbers', 'limit': 'numbers', 'sort': 'sort_param',
        'search': 'search_param', 'select': 'select_param',
        'pid': 'numbers', 'state': 'alphanumeric_param', 'ppid': 'numbers',
...
/**
 * @api {get} /syscollector/ports Get ports info of all agents
 * @apiName GetPorts
 * @apiGroup Syscollector
 *
 * @apiParam {Number} [offset] First element to return in the collection.
 ...
 *
 * @apiExample {curl} Example usage*:
 *     curl -u foo:bar -k -X GET "https://127.0.0.1:55000/syscollector/ports?pretty"
 *
 */
router.get('/ports', function (req, res) {
    logger.debug(req.connection.remoteAddress + " GET /syscollector/ports");

    var data_request = { 'function': '/syscollector/ports', 'arguments': {} };
    var filters = {
        'offset': 'numbers', 'limit': 'numbers', 'sort': 'sort_param',
        'search': 'search_param', 'select': 'select_param',
...
/**
 * @api {get} /syscollector/netaddr Get network address info of all agents
 * @apiName GetNetaddr
 * @apiGroup Syscollector
 *
 * @apiParam {Number} [offset] First element to return in the collection.
 ...
 *
 * @apiExample {curl} Example usage*:
 *     curl -u foo:bar -k -X GET "https://127.0.0.1:55000/syscollector/netaddr?pretty"
 *
 */
router.get('/netaddr', function (req, res) {
    logger.debug(req.connection.remoteAddress + " GET /syscollector/netaddr");

    var data_request = { 'function': '/syscollector/netaddr', 'arguments': {} };
    var filters = {
        'offset': 'numbers', 'limit': 'numbers', 'sort': 'sort_param',
        'search': 'search_param', 'select': 'select_param',
...
/**
 * @api {get} /syscollector/netproto Get network protocol info of all agents
 * @apiName GetNetproto
 * @apiGroup Syscollector
 *
 * @apiParam {Number} [offset] First element to return in the collection.
 ...
 *
 * @apiExample {curl} Example usage*:
 *     curl -u foo:bar -k -X GET "https://127.0.0.1:55000/syscollector/netproto?pretty"
 *
 */
router.get('/netproto', function (req, res) {
    logger.debug(req.connection.remoteAddress + " GET /syscollector/netproto");

    var data_request = { 'function': '/syscollector/netproto', 'arguments': {} };
    var filters = {
        'offset': 'numbers', 'limit': 'numbers', 'sort': 'sort_param',
        'search': 'search_param', 'select': 'select_param',
...
/**
 * @api {get} /syscollector/netiface Get network interface info of all agents
 * @apiName GetNetiface
 * @apiGroup Syscollector
 *
 * @apiParam {Number} [offset] First element to return in the collection.
 ...
 *
 * @apiExample {curl} Example usage*:
 *     curl -u foo:bar -k -X GET "https://127.0.0.1:55000/syscollector/netiface?pretty"
 *
 */
router.get('/netiface', function (req, res) {
    logger.debug(req.connection.remoteAddress + " GET /syscollector/netiface");

    var data_request = { 'function': '/syscollector/netiface', 'arguments': {} };
    var filters = {
        'offset': 'numbers', 'limit': 'numbers', 'sort': 'sort_param',
        'search': 'search_param', 'select': 'select_param',
