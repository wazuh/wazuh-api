...
describe('ConfigurationAssessment', function() {
    ...
    describe('GET/configuration-assessment/:agent_id/checks/:policy_id', function() {
        ...
        it('Request', function(done) {
            request(common.url)
            .get("/configuration-assessment/000/checks/system_audit_ssh")
            .auth(common.credentials.user, common.credentials.password)
            .expect("Content-type",/json/)
            .expect(200)
            .end(function(err,res){
        ...
        it('Pagination', function(done) {
            request(common.url)
            .get("/configuration-assessment/000/checks/system_audit_ssh?offset=0&limit=1")
            .auth(common.credentials.user, common.credentials.password)
            .expect("Content-type",/json/)
            .expect(200)
            .end(function(err,res){
        ...
        it('Retrieve all elements with limit=0', function(done) {
            request(common.url)
            .get("/configuration-assessment/000/checks/system_audit_ssh?limit=0")
            .auth(common.credentials.user, common.credentials.password)
            .expect("Content-type",/json/)
            .expect(200)
            .end(function(err,res){
        ...
        it('Sort', function(done) {
            request(common.url)
            .get("/configuration-assessment/000/checks/system_audit_ssh?sort=-")
            .auth(common.credentials.user, common.credentials.password)
            .expect("Content-type",/json/)
            .expect(200)
            .end(function(err,res){
        ...
        it('Search', function(done) {
            request(common.url)
            .get("/configuration-assessment/000/checks/system_audit_ssh?search=2")
            .auth(common.credentials.user, common.credentials.password)
            .expect("Content-type",/json/)
            .expect(200)
            .end(function(err,res){
        ...
        it('Params: Bad agent id', function(done) {
            request(common.url)
            .get("/configuration-assessment/abc/checks/system_audit_ssh")
            .auth(common.credentials.user, common.credentials.password)
            .expect("Content-type",/json/)
            .expect(400)
            .end(function(err,res){
        ...
        it('Errors: No agent', function(done) {
            request(common.url)
            .get("/configuration-assessment/9999999/checks/system_audit_ssh")
            .auth(common.credentials.user, common.credentials.password)
            .expect("Content-type",/json/)
            .expect(200)
            .end(function(err,res){
